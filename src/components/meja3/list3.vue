<template>
  <div class="content-wrapper" style="min-height: 836px;">
    ...
    <section class="content-header">
      ...
      <font color="red">Panduan Antrian pada Meja 4</font>
      <ul>
        ...
        <font color="#3C8DBC"><b><i>'Next'</i></b></font>
         jika peserta ingin tidak ingin melakukan pemeriksaan di Meja 4</li>
      </ul>
      </div>
    </section>
    ...
    >
      ...
      <template slot="actions" slot-scope="row">
        <router-link :to="{name: 'Input3', params: {id: row.item.userId, user: row.item, nim : row.item['user.NoIdentitas']}}" class="btn btn-success"><i class="fa fa-edit">Input</i> </router-link>
...
export default {
  ...
  beforeCreate() {
    ...
    if(this.lokasi){
    axios
      .get("http://52.187.24.10:8080/api/v1/petugas/antrian/meja4/"+this.lokasi)
  ...
  methods: {
    ...
    nextMeja(userid){
            var user = {
             ...
             axios.post('http://52.187.24.10:8080/api/v1/petugas/antrian/meja4/next', user)
            .then(() => {
