<template>
  <div class="content-wrapper" style="min-height: 836px;">
    ...
    <section class="content-header">
      ...
      <font color="red">Panduan Antrian pada Meja 5</font>
      <ul>
        <li>Ketikkan nama atau identitas peserta untuk melakukan Konsultasi kesehatan</li>
        <li>Pilih tombol
        <font color="#00A65A"><b><i>'HASIL'</i></b></font>
          jika ingin melihat hasil pemeriksaan</li>
        <li>Pilih tombol 
        <font color="#3C8DBC"><b><i>'Next'</i></b></font>
         jika peserta ingin tidak ingin melihat hasil pemeriksaan</li>
      </ul>
      </div>
    </section>
    ...
    >
      ...
      <template slot="actions" slot-scope="row">
        <router-link :to="{name: 'Input4', params: {id: row.item.userId, user: row.item, nim : row.item['user.NoIdentitas']}}" class="btn btn-success"><i class="fa fa-edit">HASIL</i> </router-link>
...
export default {
  ...
  beforeCreate() {
    ...
    if(this.lokasi){
    axios
      .get("http://52.187.24.10:8080/api/v1/petugas/antrian/meja5/"+this.lokasi)
  ...
  methods: {
    ...
    nextMeja(userid){
            var user = {
             ...
             axios.post('http://52.187.24.10:8080/api/v1/petugas/antrian/meja5/next', user)
            .then(() => {
                this.$router.push('/list4')
                alert("Sukses Skip Antrian")
                this.fetchAntrian()
