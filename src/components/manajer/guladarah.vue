<template>
  <div class="content-wrapper" style="min-height: 836px;">
    ...
    <section class="content-header">
      <h1>
        Gula Darah
        <small>Grafik Gula Darah Peserta Posbindu</small>
      </h1>
      <ol class="breadcrumb">
        <li>
...
export default {
  ...
  data: () => ({
    ...
    // HexcolorBar: ["#41B883", "#E46651", "#00D8FF", "#3ecc17", "#5286e2"],
    HexcolorBar : [
      "#41B883",
      "#E46651",
      "#00D8FF",
    ...
    deskripsiLine: null,
    deskripsiBar: null,
    JudulBar: "Hasil Pengukuran",
    JudulLine: "Hasil Pengukuran",
    lokasi: "Seluruh FT",
    someList: [
  ...
  async created() {
    ...
    try {
      const barData = await axios.get(
        "http://52.187.24.10:8080/api/v1/manajer/report/pengukuran/bar?type=GulaDarah"
      );
      const pieData = await axios.get(
        "http://52.187.24.10:8080/api/v1/manajer/report/pengukuran/pie?type=GulaDarah"
      );
      const lineData = await axios.get(
        "http://52.187.24.10:8080/api/v1/manajer/report/pengukuran/line?type=GulaDarah"
      );
      ...
      this.loaded = true;
      console.log(this.deskripsiLine);
      console.log(this.deskripsiPie);
    } catch (e) {
      console.error(e);
    }
  },
